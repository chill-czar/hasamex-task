...
[![CI Pipeline](https://github.com/chill-czar/hasamex-task/actions/workflows/ci.yml/badge.svg)](https://github.com/chill-czar/hasamex-task/actions/workflows/ci.yml)
[![Deploy to Google Cloud](https://github.com/chill-czar/hasamex-task/actions/workflows/deploy.yml/badge.svg)](https://github.com/chill-czar/hasamex-task/actions/workflows/deploy.yml)
[![Live Demo](https://img.shields.io/badge/Live_Demo-34.132.173.179-success)](http://34.132.173.179)
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/chill-czar/hasamex-task.git
   cd hasamex-task
   ```
...
```
*(Runs 21 automated tests verifying transcript parser, timestamp conversions, quote matcher, repository, materialized cache persistence, and all API endpoints).*
...
* Open the live platform at **[http://34.132.173.179](http://34.132.173.179)** (or local `http://localhost:3000`).
* Show the **Executive Summary**: 3 expert calls (France, Germany, UK), 3 experts, 25 canonical segments.
...
* Show that the application immediately opens the audio playback & transcript drawer, navigates to segment `call_fr_01_seg_004`, and displays the exact sentence in the canonical text.
...
### **Demo 4: Interactive Grounded Q&A (Real-Time Streaming)**
...
* Point out the real-time token-by-token streaming (TTFT < 800ms) over Server-Sent Events (SSE), followed by the verified quote card from Anna Keller (`[03:05]`).
